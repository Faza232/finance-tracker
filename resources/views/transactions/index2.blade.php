...
<div class="container mx-auto p-4">
    ...
    <!-- Tombol Filter di Navbar -->
    <button onclick="openFilterModal()" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition duration-300">Filter</button>

    <!-- Modal untuk Filter -->
    <div id="filterModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden">
        <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
            <h2 class="text-xl font-bold mb-4">Filter Transaksi</h2>
            <form action="{{ route('transactions.index') }}" method="GET" class="mb-6 bg-white p-4 rounded-lg shadow-md">
                ...
                <div class="mt-4">
                    ...
                    <button onclick="closeFilterModal()" class="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition duration-300">Tutup</button>
                </div>
            </form>
